...
It covers different practices under governance, ranging from conduct to code contributions, including security management, financial support, etc.
...
To simplify the writing of our documentation, we are following a framework named [Diátaxis](https://diataxis.fr) to help us structure and write the documentation.
...
With our scope of secret management, we are particularly careful about our security.
The list of our security processes is in our [Security Policy Reference](security_policy.md).

# More Content

All policies' content are written and linked in our Reference Information section (Find it in the navigation at the top of this page).
